  ...
  return (
    <div className="min-h-screen bg-[#FAF9F6] flex flex-col justify-center py-12 sm:px-6 lg:px-8 font-sans">
      <div className="sm:mx-auto sm:w-full sm:max-w-md text-center space-y-2">
        ...
        <h2 className="text-3xl font-extrabold text-[#0B1B3D] uppercase tracking-tight">Welcome Back</h2>
        <p className="text-xs text-muted-foreground">Log in to your executive library and continuous learning center.</p>
      </div>
      ...
      <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
        <div className="bg-white py-8 px-6 border border-[#E2E8F0] shadow-sm rounded-2xl sm:px-10">
          ...
          <div className="mt-6 border-t border-[#E2E8F0] pt-6 text-center text-xs">
            <span className="text-muted-foreground">New to PGT?</span>{' '}
            <Link href="/members/register" className="font-bold text-[#B89047] hover:underline">
